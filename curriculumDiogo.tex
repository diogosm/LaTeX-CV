...
\cvitem{Básico}{\textsc{R}, \textsc{html}, \textsc{PHP}}
\cvitem{Intermediário}{\LaTeX, \textsc{css}, API Rest, \textsc{javascript}, \textit{Network Monitoring} (Zabbix), CI/DC (Jenkins)}
\cvitem{Avançado}{\textsc{Grails}, \textsc{Groovy}, \textsc{C/C++}, Linux, \textsc{bash}, containerização (Rancher, \textsc{Docker}), SQL, \textsc{Postgres}, \textsc{MySQL/MariaDB}}
