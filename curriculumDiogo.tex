...
\cvitem{Básico}{\textsc{java}, Adobe Illustrator}
\cvitem{Intermediário}{\textsc{html}, \LaTeX, \textsc{css}, }
\cvitem{Avançado}{\textsc{Grails}, \textsc{Groovy}, \textsc{C/C++}, Linux, \textsc{bash}}
